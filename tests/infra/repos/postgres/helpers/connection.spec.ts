...
describe('PgConnection', () => {
  ...
  it('should return TransactionNotFoundError on closeTransaction if connection is not found', async () => {
  ...
  it('should return TransactionNotFoundError on commit if connection is not found', async () => {
  ...
  it('should return TransactionNotFoundError on rollback if connection is not found', async () => {
  ...
  it('should getRepository on open transaction', async () => {
    await sut.connect()
    await sut.openTransaction()
    sut.getRepository(PgUser)
